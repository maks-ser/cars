                ...
                <div class="sidebar">
                    ...
                    <div class="aside-wrapper">
                        ...
                        <div class="filter-body">
                            <!--<div class="w-block">
                                    <div class="title_custom"><span class="line"><span>Тип авто</span></span></div>
                                    <div class="check-elem-list check-elem-l-wauto">
                                        <?php foreach ($categories as $category): ?>
                                            <div class="checkbox-elem-wrapper">
                            ...
                            <div class="w-block">
                                ...
                                <!--<div class="check-elem-list check-elem-l-wauto">
                                    <input value="5" id="from">
                                    <input value="30" id="while">
                                    <div id="polzunok"></div>
                                    <b>Значение ползунка: <span style="color:green" id="result-polzunok"></span></b>
                                </div>-->
                            ...
                            foreach ($filters as $key => $filter):
                                $i = 1; ?>
                                <!--                                <div class="w-block --><?php //echo $key === 'discount' ? 'active' : ''?><!--">-->
                                <div class="w-block">
