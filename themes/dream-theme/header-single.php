...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo bloginfo('template_url'); ?>/favicon.ico"/>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/css/bootstrap.min.css"
          integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    <link href="https://fonts.googleapis.com/css2?family=Commissioner:wght@300;400;600;700&family=Nunito+Sans:ital,wght@0,300;0,400;0,600;0,700;0,800;1,800&display=swap"
          rel="stylesheet">
...
<body <?php body_class('m_single'); ?>>
<div class="header-container" style="background-color: #fff;background-image: none;">
    <header class="header">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="header-body">
                        <div class="header__logo">
                            <a href="<?php echo home_url(); ?>">
                                ...
                                <img src="<?php echo carbon_get_theme_option('logo_mobile'); ?>" alt="Logo">
                            </a>
                        </div>
                        <div class="navbar">
                            <?php wp_nav_menu([
                        ...
                        <div class="header-contacts">
                            <div class="social-networks">
                                <div class="item">
                                    <a href="<?php echo carbon_get_theme_option('instagram') ?>" target="_blank">
                                        <img src="<?php echo bloginfo('template_url'); ?>/img/instagram-icon.svg"
                                             alt="Instagram">
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="<?php echo carbon_get_theme_option('viber') ?>">
                                        <img src="<?php echo bloginfo('template_url'); ?>/img/viber-icon.svg"
                                             alt="Viber">
                                    </a>
                                </div>
                            </div>
                            <div class="numbers">
                                <p class="timetable">
                                    <?php echo pll__('Дзвоніть, Пн-Пт з 9:00 до 18:00'); ?>
                                </p>
                                ...
                                <p class="timetable">
                                    <?php echo pll__('Перерва з 13:00 до 14:00'); ?>
                                </p>
                            </div>
                        </div>
    ...
    <section class="section-banner single">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-col-lg-10 col-xl-8">
                    <ul class="distance-traveled-list">
